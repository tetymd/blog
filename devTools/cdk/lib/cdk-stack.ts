...
export class CdkStack extends cdk.Stack {
  constructor(scope: cdk.Construct, id: string, props?: cdk.StackProps) {
    ...
    isAnonymousCognitoGroupRole.addToPolicy(new iam.PolicyStatement({
      actions: [
        "appsync:GraphQL",
      ...
      resources: [
        "arn:aws:appsync:"+`${region}`+":"+`${accountId}`+":apis/"+`${api.apiId}`+"/types/Query/*"
      ]
    }))
    ...
    isUserCognitoGroupRole.addToPolicy(new iam.PolicyStatement({
      actions: [
        "appsync:GraphQL",
        "appsync:GetGraphqlApi",
        "appsync:ListGraphqlApis",
      ...
      resources: [
        "arn:aws:appsync:"+`${region}`+":"+`${accountId}`+":apis/"+`${api.apiId}/*`
      ]
    }))
